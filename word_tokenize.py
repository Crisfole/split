"""
This is word_tokenize from [splitta](https://code.google.com/p/splitta/).

It is used to test that my results are identical to splitta's.

I added this comment and a way to run this from the cmd line.
"""
...
if __name__ == "__main__":
    fileinput.open = lambda filename, mode: codecs.open(filename, model, 'utf8')
